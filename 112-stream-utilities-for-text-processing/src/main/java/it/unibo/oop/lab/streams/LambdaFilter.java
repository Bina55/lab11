...
public final class LambdaFilter extends JFrame {
    ...
    private enum Command {
        ...
        LOWERCASE("Convert to lower case", s -> s.toLowerCase()),
        COUNT_CHAR("Count the number of chars", s -> Integer.toString(s.length())),
        COUNT_LINES("Count the number of lines", s -> Integer.toString((int)s.lines().count())),
        ORDER("List all the word in alphabetical order", s -> 
